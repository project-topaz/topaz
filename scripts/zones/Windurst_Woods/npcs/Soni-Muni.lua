...
function onEventFinish(player,csid,option)
    ...
    elseif csid == 484 and npcUtil.completeQuest(player, WINDURST, tpz.quest.id.windurst.THE_AMAZIN_SCORPIO, {xp=1600, fame=80, title=tpz.title.GREAT_GRAPPLER_SCORPIO, gil=1500}) then
        player:confirmTrade()
