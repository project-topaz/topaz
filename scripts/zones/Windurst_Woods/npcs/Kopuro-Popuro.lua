...
function onEventFinish(player,csid,option)
    ...
    elseif csid == 292 and npcUtil.completeQuest(player, WINDURST, tpz.quest.id.windurst.THE_ALL_NEW_C_2000, {fame=80, title=tpz.title.CARDIAN_TUTOR, gil=200, xp=800}) then
        player:confirmTrade()
