...
function onTrigger(player,npc)
	...
	if tutorial == 11 then
		...
		local hasCrystal = player:hasKeyItem(dsp.ki.HOLLA_GATE_CRYSTAL)
		if (tutorial == 3) then
			for i = 1, 12 do
		...
		elseif tutorial == 10 then
			if not hasCrystal then
				player:startEvent(931,dsp.ki.HOLLA_GATE_CRYSTAL,0,2,0,0,0,0,0)
			else
				player:startEvent(932,dsp.ki.HOLLA_GATE_CRYSTAL,2500,1789,3,0,0,0,0)
			end
		end
	end
end
