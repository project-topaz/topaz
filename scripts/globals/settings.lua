...
EXP_RATE        = 1.500; -- Multiplies exp earned from quests. Tantalus default: 1.500
FOV_RATE        = 0.000; -- Normal: 0.78
FOV_GIL         = 1.000; -- Multiplies gil earned from fov. Normal: 1.0
...
-- DYNAMIS SETTINGS
   ...
   PRISMATIC_HOURGLASS_COST = 30000;    -- cost of the prismatic hourglass for Dynamis.
...
TIMEZONE_OFFSET = 0.0; -- Offset from UTC used to determine when "JP Midnight" is for the server.  Default is JST (+9.0).
...
GOBBIE_BOX_MIN_AGE  = 21 -- Minimum character age in days before a character can sign up for Gobbie Mystery Box