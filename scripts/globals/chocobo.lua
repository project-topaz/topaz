...
local chocoboInfo =
{
    ...
    [dsp.zone.SOUTHERN_SAN_DORIA_S]    = {levelReq = 10, basePrice = 150, addedPrice = 20, decayPrice = 5, decayTime = 90, questChance = 0.00, past = true , pos = {94, -62, 266, 40, 81}},
    ...
    [dsp.zone.BASTOK_MARKETS_S]        = {levelReq = 10, basePrice = 150, addedPrice = 20, decayPrice = 5, decayTime = 90, questChance = 0.00, past = true , pos = {380, 0, 147, 192, 88}},
    ...
    [dsp.zone.WINDURST_WATERS_S]       = {levelReq = 10, basePrice = 150, addedPrice = 20, decayPrice = 5, decayTime = 90, questChance = 0.00, past = true , pos = {320, -4, -46, 192, 95}},
    ...
    [dsp.zone.SOUTHERN_SAN_DORIA]      = {levelReq = 10, basePrice = 100, addedPrice = 20, decayPrice = 5, decayTime = 60, questChance = 0.10, past = false, pos = {-126, -62, 274, 101, 100}},
    [dsp.zone.BASTOK_MINES]            = {levelReq = 10, basePrice = 100, addedPrice = 20, decayPrice = 5, decayTime = 60, questChance = 0.10, past = false, pos = {580, 0, -305, 64, 107}},
    [dsp.zone.WINDURST_WOODS]          = {levelReq = 10, basePrice = 100, addedPrice = 20, decayPrice = 5, decayTime = 60, questChance = 0.10, past = false, pos = {-122, -4, -520, 0, 116}},
