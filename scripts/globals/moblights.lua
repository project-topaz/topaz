...
tpz.abyssea_mob.info =
{
    ...
    ["Bhumi"]                  = {azure = 16,  pearl = 16,  ruby = 16,  amber = 16 },
...
tpz.abyssea_mob.DropLights = function(killer, mobName, killType, mob)
    ...
    elseif mobName == "" or mobName == nil then
        return
    else
        return
    end
    ...
    if dropLight == tpz.abyssea.lightType.AZURE then
