...
function onMobSpawn(mob)
        mob:addGambit({ ai.t.SELF, ai.c.ALWAYS, 0 }, { ai.r.JA, ai.s.SPECIFIC, tpz.ja.PROVOKE })
        mob:addGambit( { ai.t.SELF, ai.c.TP_GTE, 1000 }, { ai.r.WS, ai.s.SPECIFIC, tpz.ws.BURNING_BLADE })
end
